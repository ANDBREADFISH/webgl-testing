...
function buffer(gl3, data, program, attribute, size, type) {
    ...
    if (a == -1) {
        throw new Error('Could not find attribute: ' + attribute);
    }
...
setInterval(function () {
    if (gl3 == null) {
        throw new Error('webgl3 context is null');
    }
